...
class Solution {
    public long minDamage(int power, int[] damage, int[] health) {
        ...
        // Sort enemies in decreasing order of damage
        enemies.sort((a, b) -> Long.compare(b.damage, a.damage));
        ...
        for(Enemy enemy : enemies) {
            ...
            long t = (enemy.health + power -1) / power;
            totalTime += t;
            totalDamage += enemy.damage * totalTime;
        }
